...
os.environ.setdefault("CAMPAIGN_DAYS", "24")
os.environ.setdefault("CAMPAIGN_REMINDER_DEADLINE_HOUR", "8")
os.environ.setdefault("CAMPAIGN_MISSED_DEADLINE_HOUR", "22")
os.environ.setdefault("CAMPAIGN_QUIET_HOURS_START", "23")
os.environ.setdefault("CAMPAIGN_QUIET_HOURS_END", "7")
os.environ.setdefault("CAMPAIGN_MAX_ATTEMPTS_PER_DAY", "3")
os.environ.setdefault("CAMPAIGN_TZ", "UTC")
